...
public class MessageAdapter extends BaseAdapter{
	...
	private View createViewByMessage(EMMessage message, int position) {
		...
		case LOCATION:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_location, null) : inflater.inflate(
					R.layout.easeui_row_sent_location, null);
		case IMAGE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_picture, null) : inflater.inflate(
					R.layout.easeui_row_sent_picture, null);

		case VOICE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_voice, null) : inflater.inflate(
					R.layout.easeui_row_sent_voice, null);
		case VIDEO:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_video, null) : inflater.inflate(
					R.layout.easeui_row_sent_video, null);
		case FILE:
			return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_file, null) : inflater.inflate(
					R.layout.easeui_row_sent_file, null);
		default:
			// 语音通话
			if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VOICE_CALL, false))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_voice_call, null) : inflater
						.inflate(R.layout.easeui_row_sent_voice_call, null);
			// 视频通话
			else if (message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VIDEO_CALL, false))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_video_call,
						null) : inflater.inflate(R.layout.easeui_row_sent_video_call, null);
			// 含有菜单的消息	
			else if (((DemoHXSDKHelper)HXSDKHelper.getInstance()).isRobotMenuMessage(message))
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_menu, null)
						: inflater.inflate(R.layout.easeui_row_sent_message, null);
			else
				return message.direct == EMMessage.Direct.RECEIVE ? inflater.inflate(R.layout.easeui_row_received_message,
						null) : inflater.inflate(R.layout.easeui_row_sent_message, null);
		}
	}
