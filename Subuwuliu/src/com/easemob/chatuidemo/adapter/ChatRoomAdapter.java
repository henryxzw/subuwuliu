...
public class ChatRoomAdapter extends ArrayAdapter<EMChatRoom> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (getItemViewType(position) == 0) {
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.easeui_search_bar_with_padding, null);
			}
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.easeui_row_add_group, null);
			}
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.easeui_row_group, null);
			}
