...
public class ContextMenu extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (type == EMMessage.Type.TXT.ordinal()) {
		    setContentView(R.layout.easeui_context_menu_for_text);
		} else if (type == EMMessage.Type.LOCATION.ordinal()) {
		    setContentView(R.layout.easeui_context_menu_for_location);
		} else if (type == EMMessage.Type.IMAGE.ordinal()) {
		    setContentView(R.layout.easeui_context_menu_for_image);
		} else if (type == EMMessage.Type.VOICE.ordinal()) {
		    setContentView(R.layout.easeui_context_menu_for_voice);
		} else if (type == EMMessage.Type.VIDEO.ordinal()) {
			setContentView(R.layout.easeui_context_menu_for_video);
		}
