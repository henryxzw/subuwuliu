...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.easeui_fragment_conversation_history, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				if (adapter.getItem(position).getUsername().equals(DiDiApplication.getInstance().getUserName()))
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), R.layout.easeui_row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
