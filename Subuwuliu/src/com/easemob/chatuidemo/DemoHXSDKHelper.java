...
public class DemoHXSDKHelper extends HXSDKHelper{
    ...
    /**
     * 冯奕欢 2016.03.25 修改环信被逼下线，应该跳到我们的主页
     */
    @Override
    protected void onConnectionConflict(){
    	System.out.println("账号在别的地方登录");
    	String userName = DiDiApplication.getInstance().getUserName();
    	String userPassword = DiDiApplication.getInstance().getPassword();
    	if(DiDiApplication.VALUE_UNKOWN.equals(userName) || DiDiApplication.VALUE_UNKOWN.equals(userPassword)) {
    		System.out.println("司机已经下线，不能再次启动HomeActivity");
    		return ;
    	}
    ...
    /**
     * 冯奕欢 2016.03.25 修改环信账号被移除，应该跳到我们的主页
     */
    @Override
