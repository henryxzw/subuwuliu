...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(Color.parseColor("#6c6c6c"));
            } else {
    ...
    public void setFullLine(boolean isFullLine) {
    ...
    private void onSeletedCallBack() {
        if (null != onWheelViewListener) {
        	   System.out.println("-------E---------->>"+items.get(selectedIndex));
    ...
    public void fling(int velocityY) {
        super.fling(velocityY / flingSpeed);
    }
